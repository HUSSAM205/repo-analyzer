...
export function AnalysisProgress({ stage }: { stage: Job["stage"] | null | undefined }) {
  ...
  return (
    <section className="border-b border-border/60 px-4 py-5" data-testid="analysis-progress">
              ...
              <div className="flex w-full items-center">
                <div
                  className={cn(
                    ...
                    i === 0 ? "opacity-0" : isDone || isCurrent ? "bg-primary/60" : "bg-border"
                  )}
                />
                <motion.div
                  aria-label={
                  ...
                  className={cn(
                    ...
                    isDone && "border-emerald-400/70 bg-emerald-400/10 text-emerald-500 dark:text-emerald-400",
                ...
                <div
                  className={cn(
                    "h-px flex-1 transition-colors duration-200",
                    i === STAGES.length - 1 ? "opacity-0" : isDone ? "bg-primary/60" : "bg-border"
                  )}
                />
              </div>
              <span
